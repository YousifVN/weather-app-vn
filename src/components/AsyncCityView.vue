  ...
  <div class="flex flex-col items-center flex-1">
    ...
    <div class="w-full max-w-screen-md py-12">
      <div class="mx-8 text-white">
        <h2 class="mb-5 text-xl font-bold text-center">Hourly Weather</h2>
    ...
    <div class="w-full max-w-screen-md py-12">
      <div class="mx-8 text-white">
        <h2 class="mb-5 text-xl font-bold text-center">7 Day Forecast</h2>
        <div
    ...
    <div
      class="flex items-center gap-2 py-12 text-red-500 duration-150 cursor-pointer hover:font-bold"
      @click="removeCity">
